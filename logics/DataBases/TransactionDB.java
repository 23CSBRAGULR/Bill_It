...
public class TransactionDB {
    ...
    private UserDB user; // or use an interface/base class if possible

    public TransactionDB(UserDB user) {
        this.user = user;
    }

    public TransactionDB() {
        // Default constructor for initialization without user context
    }
        ...
        switch(action) {
            ...
            case 2:
                if (user instanceof Staff) {
                    ...
                    System.out.println("Unknown user type." + this.toString());
                }
                break;
            default:
